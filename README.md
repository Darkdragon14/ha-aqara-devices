...
`Aqara Devices (G3, G2H Pro, G410, G4, M3, M100, M200, FP2, FP300, and A100 Pro)` connects supported Aqara cameras, doorbells, hubs, presence sensors, and locks to Home Assistant with Aqara Open API v3 and `aqara-rocketmq-bridge`.
